...
public class GetPostSteps {
	...
	@Dado("^que eu realizo a operação GET para$")
	public void que_eu_realizo_a_operação_GET_para() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	  System.out.println("testando");
		
		Response response = RestAssured.get("https://webservice.toscacloud.com/training/swagger/docs/v1");
	    
	}

	@Entao("^devo ver o nome do autor como$")
	public void devo_ver_o_nome_do_autor_como() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions	
